...
import com.jobayed.orderservice.controller.endpoint.SalesController;
 ...
 */
@ControllerAdvice(assignableTypes = {SalesController.class})
@Slf4j
@RequiredArgsConstructor
public class SalesControllerExceptionResolver {
    ...
    protected String buildErrorCode(final String errorCode) {
        return new StringBuilder().append(properties.getCode())
                .append('_')
                .append(Constants.FeatureCode.SALES)
                .append('_')
                .append(errorCode)
                .toString();
    }
